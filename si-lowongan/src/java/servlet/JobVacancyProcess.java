        ...
        try {
            try {
                ...
                if(request.getParameter("submit_job_vacancy").equals("submit")){                    
                    ...
                    Date date = new Date();
                    jobVacancy.setIdJobVacancy("job"+date.toString());
                    jobVacancy.setTitleVacancy(request.getParameter("txt_vacancy_name"));
                    jobVacancy.setIdJob(null);
                    jobVacancy.setIdManager(null);
                    jobVacancy.setNumberPosition(0);
                    jobVacancy.setDescription(null);
                    jobVacancy.setStatus(null);
                    jobVacancy.setPostDate(null);
